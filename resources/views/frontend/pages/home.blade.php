...
<link rel="og:url" href="{{ Request::root() }}">
            ...
            <div class="col-12 mb-4">
                ...
                <article class="card article-card">
                        ...
                        <div class="card-image">
                            <div class="post-info"> <span
                                ...
                                <span
                                    ...
                                    @choice('min|mins', readDuration(single_latest_post()->post_title, single_latest_post()->post_content))</span>
                            </div>
                    ...
                    <div class="card-body px-0 pb-1">
                        ...
                        <p class="card-text">{!! Str::ucfirst(words(single_latest_post()->post_content, 35)) !!}
                        </p>
                        <div class="content"> <a class="read-more-btn"
                                href="{{ route('read_post', single_latest_post()->post_slug) }}">Artigo
                                completo</a>
                        </div>
                    </div>
                </article>
                        ...
                        <div class="card-image">
                            <div class="post-info"> <span
                                ...
                                <span
                                    ...
                                    @choice('min|mins', readDuration($item->post_title, $item->post_conten))</span>
                            </div>
                            <img loading="lazy" decoding="async"
                    ...
                    <div class="widget">
                        <div class="widget-body">
                            ...
                            <p class="mb-3 pb-2">Sou desenvolvedor Full Stack com foco no desenvolvimento de sistemas
                                ...
                                princípios SOLID e versionamento com Git.</p> <a href="{{ route('about') }}" class="btn btn-sm btn-outline-primary">Saber mais</a>
                        </div>
                    </div>
                </div>
